...
<body>
  ...
  <div class="container" id="main">
    <div class="row">
      ...
      $infopeliculas = $pelicula->mostrar();
      $cantidad = count($infopeliculas);
      if ($cantidad > 0) {
        for ($x = 0; $x < $cantidad; $x++) {
          $item = $infopeliculas[$x];
      ?>
          <div class="col-md-3">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h1 class="text-center titulo-pelicula"><?php print $item['title'] ?></h1>
              </div>
              <div class="panel-body catalogo-card">
                <?php
